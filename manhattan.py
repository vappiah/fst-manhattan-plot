...
def mhat(df="dataframe", chr=None, pv=None, color=None, dim=(8,4), r=300, ar=None, fst_sign_line=False,
             fst=0.3, dotsize=8, markeridcol=None, markernames=None, gfont=8, valpha=1, show=False, figtype='png',
        ...
        if fst_sign_line is True:
            ax.axhline(y=fst, linestyle='--', color='yellow', linewidth=1)
